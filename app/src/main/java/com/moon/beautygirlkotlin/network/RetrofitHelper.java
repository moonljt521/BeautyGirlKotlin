...
import com.moon.beautygirlkotlin.network.api.DoubanMeizhiApi;
import com.moon.beautygirlkotlin.network.api.GankMeiziApi;
import com.moon.beautygirlkotlin.network.api.HuaBanMeiziApi;
import com.moon.beautygirlkotlin.network.api.MeiziTuApi;
  ...
  private static void initOkHttpClient() {
    ...
    if (mOkHttpClient == null) {
      synchronized (RetrofitHelper.class) {
        if (mOkHttpClient == null) {
          //设置Http缓存
          Cache cache = new Cache(new File(BeautyGirlKotlinApp.application.getCacheDir(), "HttpCache"),
              1024 * 1024 * 100);
